...
<head>
    ...
    <title><?php echo $resultQuery['pot_nome'];?> - INSPIRERN</title>
</head>
<body>
    ...
    <section class="carousel bg-[url('../img/foto_ponto_menu_02.jpeg')] bg-no-repeat bg-center bg-cover bg-fixed">
        <div class="bg-black-gd">
          <header class="container mx-auto text-white">
                ...
                <div class="mt-12">
                    <h1 class="text-7xl mt-28 mb-7"><?php echo $resultQuery['pot_nome'];?></h1>
                    <div>
    ...
    <section class="bg-gray-50 pt-10">
        <div class="container mx-auto">
            <div class="flex">
                <div class="w-1/2">
                    <h1 class="text-5xl mt-10 pb-12"><?php echo $resultQuery['pot_nome'];?></h1>
                    <div class="space-y-20">
                        <div>
                            <span class="text-3xl"><ion-icon name="location-outline"></ion-icon></span>
                            <h3 class="text-xl font-semibold">Localização</h3>
                            <p class="text-lg text-black">Situado na <?php echo $resultQuery['pot_rua'];?>, <?php echo $resultQuery['pot_bairro'];?></p>
                        </div>
                        <div class="flex space-x-20">
                            <div>
                                <span class="text-3xl"><ion-icon name="star-half-outline"></ion-icon></span>
                                <h3 class="text-xl font-semibold">Classificação</h3>
                                <p class="text-lg text-yellow-500"><?php echo $resultQuery['pot_classificacao'];?></p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <?php 
                                    if($resultQuery['pot_acessibilidade'] == 'disponivel') {
                                      echo  "<p class='text-lg text-green-600'>".$resultQuery['pot_acessibilidade']."</p>";
                                    } else {
                                        echo  "<p class='text-lg text-red-600'>".$resultQuery['pot_acessibilidade']."</p>";
                                    }
                                ?>
                            </div>
                        </div>
            ...
            <div>
                ...
                <div class="flex">
                        <div class="w-3/4 text-lg space-y-4 text-justify mr-10">
                            <?php
                                $descricao = $resultQuery['pot_descricao'];
                                $paragrafos = explode("\n", $descricao);
