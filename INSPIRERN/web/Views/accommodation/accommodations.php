...
<head>
    ...
    <title>Hospedagens - INSPIRERN</title>
</head>
<body>

    <!--header-->

    <section class="carousel bg-[url('../img/restaurant_menu_1.webp')] bg-no-repeat bg-bottom bg-cover bg-fixed">
        <div class="bg-black-gd">
          <header class="container mx-auto text-white">
                ...
                <div class="mt-12">
                    <h1 class="text-7xl mt-28 mb-7">Hospedagens</h1>
                    <div>
                    <p class="text-lg pb-40 ">Explore uma seleção diversificada de hospedagens em nosso site. Oferecemos uma variedade de opções para<br> atender às suas necessidades de estadia, desde aconchegantes pousadas à beira-mar até hotéis de luxo no coração da cidade.</p>
                    </div>
                </div>
            </header>
        </div>
    ...
    <section class="bg-gray-50 pt-10">
        <div class="container mx-auto pb-10">
            <h1 class="text-5xl mt-10 pb-12">Hospedagens Recomendadas para Você</h1>
        <div class="flex items-center space-x-5">
            <div class="relative hover:scale-110 transform ease-in-out">
                ...
                <p class="absolute bottom-0 left-0 p-2 text-gray-50 text-3xl border rounded-md border-transparent">Hotel Paraíso Tropical</p>
            </div>
            <div class="relative hover:scale-110 transform ease-in-out">
                <img src="../../public/img/ponto-rn-1.jpg" alt="" class="border rounded-md border-transparent drop-shadow-md">
                <img src="../../public/img/sombra.png" alt="" class="absolute bottom-0 border rounded-md border-transparent">
                <p class="absolute bottom-0 left-0 p-2 text-gray-50 text-3xl border rounded-md border-transparent">Pousada das Palmeiras</p>
            </div>
            <div class="relative hover:scale-110 transform ease-in-out">
                <img src="../../public/img/ponto-rn-2.jpg" alt="" class="border rounded-md border-transparent drop-shadow-md">
                <img src="../../public/img/sombra.png" alt="" class="absolute bottom-0 border rounded-md border-transparent">
                <p class="absolute bottom-0 left-0 p-2 text-gray-50 text-3xl border rounded-md border-transparent">Hotel Estrela do Mar</p>
            </div>
            <div class="relative hover:scale-110 transform ease-in-out">
                <img src="../../public/img/ponto-rn-3.jpg" alt="" class="border rounded-md border-transparent drop-shadow-md">
                <img src="../../public/img/sombra.png" alt="" class="absolute bottom-0 border rounded-md border-transparent">
                <p class="absolute bottom-0 left-0 p-2 text-gray-50 text-3xl border rounded-md border-transparent">Pousada Encanto Potiguar</p>
            </div>
        </div>
    </div>
    </section>
    ...
    <section class="bg-gray-50 pt-10">
        <div class="container mx-auto pb-10">
            <h1 class="text-5xl mt-10 pb-12">Hospedagens mais Avaliadas</h1>
        <div class="flex items-center space-x-5">
            <div class="relative hover:scale-110 transform ease-in-out">
    ...
    <section class="bg-gray-50 pt-10">
        <div class="container mx-auto pb-10">
            <div class="bg-[url('../img/mon.jpg')] bg-no-repeat bg-top bg-cover text-gray-50 text-lg p-5 flex flex-col border rounded-md border-transparent">
                <p class="mt-16 mb-5">Praia</p>
                <h1 class="text-5xl mb-3">Calmaria e paz</h1>
                <p class="mb-5">Vem conferir as hospedagens mais calmas e muito mais!</p>
    ...
    <section class="bg-gray-50 pt-10">
        <div class="container mx-auto pb-10">
            <h1 class="text-5xl mt-10 pb-12">Top 4 Hospedagens</h1>
            <div class="flex items-center space-x-5">
                <div class="relative hover:scale-110 transform ease-in-out">
                    <img src="../../public/img/Restaurante-rn.jpg" alt="" class="border rounded-md border-transparent drop-shadow-md">
                    <img src="../../public/img/sombra.png" alt="" class="absolute bottom-0 border rounded-md border-transparent">
                    <p class="absolute bottom-0 left-0 p-2 text-gray-50 text-3xl border rounded-md border-transparent">Praia Dourada Hotel</p>
                </div>
                <div class="relative hover:scale-110 transform ease-in-out">
...
divs.forEach(div => {
    div.addEventListener('click', () => {
        ...
        window.location.href = `/accommodation?name=${encodeURIComponent(name)}`;
    });
});
</script>
</body>
