...
<head>
    ...
    <title><?php echo $resultQuery['hos_nome'];?> - INSPIRERN</title>
</head>
<body>
        ...
        <div class="bg-black-gd">
          ...
          <header class="container mx-auto text-white">
                ...
                <div class="mt-12 mx-auto">
                    ...
                    <h1 class="text-7xl text-center font-semibold mt-28 mb-7"><?php echo $resultQuery['hos_nome'];?></h1>
    ...
    <section class="bg-gray-50 pt-10 pb-10">
        ...
        <div class="container mx-auto">
            ...
            <div>
                <h2 class="text-5xl text-center mt-10 pb-20">Principais Quartos</h2>
            </div>
        ...
        <div class="container mx-auto">
            ...
            <div class="flex bg-gray-100 border rounded-md border-transparent">
                ...
                <div class="w-1/2 mx-auto p-10 pb-0 space-y-3">
                    ...
                    <?php
                        $descricao = $resultQuery['hos_descricao'];
                        $paragrafos = explode("\n", $descricao);
                        for ($i = 0; $i < 7; $i++) {
    ...
    <section class="bg-[url('../../public/img/restaurants/foto_informações_importantes.jpg')]">
        ...
        <div class="container mx-auto pt-14 pb-14">
            ...
            <ul class="list-disc ml-4 space-y-2 text-lg">
                <li><span class="font-semibold">Número de Telefone:</span> <?php echo $resultQuery['hos_telefone'];?></li>
                <li><span class="font-semibold">Email:</span> <?php echo $resultQuery['hos_email'];?></li>
                <li><span class="font-semibold">Preço médio:</span> <?php echo $resultQuery['hos_valor'];?></li>
                <li><span class="font-semibold">Classificacao:</span> <?php echo $resultQuery['hos_classificacao'];?></li>
                <li><span class="font-semibold">Acessibilidade:</span> <?php echo $resultQuery['hos_acessibilidade'];?></li>
                <li><span class="font-semibold">Localização:</span> <?php echo $resultQuery['hos_numero'] . ", " . $resultQuery['hos_rua'] . ", " . $resultQuery['hos_bairro'];?></li>
            </ul>
    ...
    <section class="bg-gray-50 pt-1">
        ...
        <div class="container mx-auto pb-10">
            <h2 class="text-5xl mt-10 pb-12">Restaurantes Proximos</h2>
